...
import { LiquidationRepository, VolumeRepository } from '../src/repositories/index.js'
...
async function syncMasterTables () {
  ...
  try {
    ...
    const liquidationsSynced = await liquidationRepo.syncFromMaster()
    ...
    const volumeSynced = await volumeRepo.syncFromMaster()
