...
import { TooltipElement } from './tooltip-element.ts';
import type { TooltipOptions } from './tooltip-element.ts';
import { positionsLine, convertTime, formattedDateAndTime } from './helpers';
...
export interface TooltipPrimitiveOptions {
	...
	priceExtractor: <T extends WhitespaceData>(dataPoint: T, logicalIndex: number) => string;
}
